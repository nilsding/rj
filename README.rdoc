...
a tool that's like <code>jq</code> but uses Ruby expressions
...
- {whatever else mruby 3.1.0 needs}[https://github.com/mruby/mruby/blob/3.1.0/doc/guides/compile.md#prerequisites] :^)
